...
export default function AccountClient() {
  const { user, loading, loginWithEmailPassword, registerWithEmailPassword, loginWithGoogle, logout } = useAuth();
          ...
          <section className="space-y-3 rounded-2xl border border-white/15 bg-white/5 p-5 shadow-inner shadow-sky-900/30">
            ...
            {loading ? (
              ...
              <div className="space-y-2 text-sm text-sky-100">
                ...
                <p className="text-xs text-sky-200">
                  After signing in, any new orders will show up under your account in future My Orders features.
                </p>
              </div>
            )}
          </section>
