...
export default function Footer() {
  return (
    <footer className="mt-16 border-t border-white/10 bg-[#020617]/80 text-sky-50 backdrop-blur-xl">
      ...
      <div className="border-t border-white/10 bg-white/5 py-4 text-center text-xs text-sky-200 backdrop-blur">
