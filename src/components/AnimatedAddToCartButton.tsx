...
const baseClasses =
  "btn-shine relative inline-flex items-center justify-center gap-2 rounded-full border border-white/70 bg-white/90 px-4 py-2 text-sm font-semibold text-slate-900 shadow-sm shadow-black/10 transition-transform duration-200 hover:border-slate-200/80 hover:shadow-[0_8px_18px_rgba(125,211,252,0.22)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60";
