                ...
                >
                  <div className="p-3">
                    {user ? (
                      ...
                      <>
                        <button
                          ...
                          className="flex w-full items-center justify-center rounded-xl bg-gradient-to-r from-sky-400 to-cyan-300 px-3 py-2 text-sm font-semibold text-slate-900 shadow-md shadow-cyan-500/30 transition hover:from-sky-300 hover:to-cyan-200"
                          role="menuitem"
                        >
                          {t("menu.signIn")}
                        </button>
                    ...
                    <div className="space-y-2">
                      <p className="px-2 text-xs font-semibold uppercase tracking-[0.22em] text-sky-200">
                        {t("menu.preferences")}
                      </p>
                      <div className="space-y-3 rounded-xl border border-white/10 bg-white/5 p-3">
                        <label className="flex items-center justify-between text-xs font-semibold text-sky-100">
                          ...
                          <select
                            ...
                            className="rounded-lg border border-white/15 bg-slate-900/60 px-2 py-1 text-xs text-white shadow-inner shadow-black/20 focus:outline-none focus:ring-2 focus:ring-white/40"
                          >
                        ...
                        <div className="flex items-center justify-between text-xs font-semibold text-sky-100">
                          ...
                          <div className="flex rounded-full border border-white/15 bg-slate-900/50 p-0.5 text-[11px] font-semibold text-sky-100">
                            <button
                              type="button"
