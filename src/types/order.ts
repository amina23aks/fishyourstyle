...
export type ShippingInfo = {
  ...
  /** Delivery address */
  address: string;
  /** Delivery mode: "home" (à domicile) or "desk" (Stop Desk) */
  mode: ShippingMode;
...
export type Order = {
  ...
  id: string;
  /** Firebase user ID (if the customer checked out while authenticated) */
  userId?: string;
  /** Customer email address (from auth or optional checkout entry) */
