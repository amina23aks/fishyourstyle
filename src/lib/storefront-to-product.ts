...
export function normalizeStorefrontImages(images: StorefrontProduct["images"] | unknown): string[] {
...
export function mapStorefrontToProduct(sp: StorefrontProduct): Product {
  const normalizedImages = normalizeStorefrontImages(sp.images);
